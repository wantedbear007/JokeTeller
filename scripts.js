...
function toggleButton() {
    // !button.disabled is for vice versa meaning that if disabled it will be true
...
function tellMe(joke) {
    ...
    VoiceRSS.speech({
        key: 'e7d45b76c9444add9d5cc6d523c83b9e',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Miscellaneous,Dark,Pun,Spooky?blacklistFlags=nsfw,religious,racist,sexist';
...
// ended is used as when the joke is playing the button should be disabled and vice-versa
